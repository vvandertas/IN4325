...
SELECT 
	participant_type,
	questionnaire::hstore -> 'usefulness' AS score,
	COUNT(*) AS num_votes
FROM filtered_users
GROUP BY participant_type, questionnaire::hstore -> 'usefulness'
...
WHERE NOT hits.participant_type = 'NOHINT' -- this question was not asked to the NOHINT group