...
<head>
    <meta charset="UTF-8">
    <title>Bing Web Search API Integration</title>

    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="assets/css/bing.css">



    <base target="_blank">
</head>
<body onload="document.forms.bing.searchQuery.focus();">
<div class="container row" style="margin-top: 25px;">
    <div class="col-md-8">
        <form id="searchForm" method="GET" name="bing" action="/">

            <div id="logo" style="float:left"><!-- logo.ftl block including search market/language -->
                ...
                <I>api</I>
                <p><select name="where" style="display: none;">
            ...
            <div id="searchQuery"><!-- searchQuery controls including search field and options -->
                <!--TODO: Change me-->
                ...
                <p>Promote
                    ...
                    &nbsp;&nbsp;&nbsp;<input type=checkbox id="safe" name="safe" value="on" checked><label
                            for="safe">SafeSearch</label>
        ...
        <div id="paging1">
            <div id="_paging1">
                <p class='paging'><i class='resultInfo'></i>
...
<script type="text/javascript" src="assets/js/bing.js"></script>
<script type="text/javascript" src="assets/js/experiment.js"></script>
